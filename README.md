...
- LOGISTICS NETWORKS - Global is default one, create new ones if needed (i use it for local networks like JUPITER-SOI or MARS-SOI). You can use multiple networks on one object.
